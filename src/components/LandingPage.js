		...
		<div>
			<div className="personalCon">
				<div className="flexCon">
					...
					>
						Welcome to my site! I'm Gavin, a full stack web developer that
						primarily works in React/Node with JavaScript, while also being
						competent in working with Python. I am passionate about programming
						because I love building things that help people improve themselves
						or keep track of their data. You can check out my recent projects{' '}
